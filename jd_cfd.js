...
!(async () => {
  ...
  await requestAlgo();
  let res = {}, res2 = await getAuthorShareCode("https://ghproxy.com/https://raw.githubusercontent.com/seatom/updateTeam/main/shareCodes/cfd.json")
  if (new Date().getHours() <= 3) res = await getAuthorShareCode('http://cdn.annnibb.me/cfd.json');
  if (!res2) res2 = await getAuthorShareCode('https://ghproxy.com/https://raw.githubusercontent.com/seatom/updateTeam/main/shareCodes/cfd.json')
